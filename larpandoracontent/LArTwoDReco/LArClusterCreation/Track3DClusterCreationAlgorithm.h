/**
 *  @file   larpandoracontent/LArTwoDReco/LArClusterCreation/Track3DClusterCreationAlgorithm.h
 *
 *  @brief  Header file for the cluster creation algorithm class.
 *
 *  $Log: $
 */
#ifndef LAR_TRACK_3D_CLUSTER_CREATION_ALGORITHM_H
#define LAR_TRACK_3D_CLUSTER_CREATION_ALGORITHM_H 1
...
/**
 *  @brief  Track3DClusterCreationAlgorithm class
 */
class Track3DClusterCreationAlgorithm : public pandora::Algorithm
{
public:
    /**
     *  @brief  Default constructor
     */
    Track3DClusterCreationAlgorithm();
...
inline Track3DClusterCreationAlgorithm::HitAssociation::HitAssociation(const pandora::CaloHit *const pPrimaryTarget, const float primaryDistanceSquared) :
...
inline void Track3DClusterCreationAlgorithm::HitAssociation::SetSecondaryTarget(const pandora::CaloHit *const pSecondaryTarget, const float secondaryDistanceSquared)
{
...
inline const pandora::CaloHit *Track3DClusterCreationAlgorithm::HitAssociation::GetPrimaryTarget() const
{
...
inline const pandora::CaloHit *Track3DClusterCreationAlgorithm::HitAssociation::GetSecondaryTarget() const
{
...
inline float Track3DClusterCreationAlgorithm::HitAssociation::GetPrimaryDistanceSquared() const
{
...
inline float Track3DClusterCreationAlgorithm::HitAssociation::GetSecondaryDistanceSquared() const
{
...
#endif // #ifndef LAR_TRACK_3D_CLUSTER_CREATION_ALGORITHM_H
