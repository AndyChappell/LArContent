/**
 *  @file   larpandoracontent/LArTwoDReco/LArClusterAssociation/LongitudinalAssociation3DAlgorithm.h
 *
 *  @brief  Header file for the longitudinal association 3d algorithm class.
 *
 *  $Log: $
 */
#ifndef LAR_LONGITUDINAL_ASSOCIATION_3D_ALGORITHM_H
#define LAR_LONGITUDINAL_ASSOCIATION_3D_ALGORITHM_H 1
...
/**
 *  @brief  LongitudinalAssociation3DAlgorithm class
 */
class LongitudinalAssociation3DAlgorithm : public ClusterAssociationAlgorithm
{
public:
    /**
     *  @brief  Default constructor
     */
    LongitudinalAssociation3DAlgorithm();
...
#endif // #ifndef LAR_LONGITUDINAL_ASSOCIATION_3D_ALGORITHM_H
