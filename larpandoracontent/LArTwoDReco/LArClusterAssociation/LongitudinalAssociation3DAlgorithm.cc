/**
 *  @file   larpandoracontent/LArTwoDReco/LArClusterAssociation/LongitudinalAssociation3DAlgorithm.cc
 *
 *  @brief  Implementation of the longitudinal association 3d algorithm class.
 *
 *  $Log: $
 */
...
LongitudinalAssociation3DAlgorithm::LongitudinalAssociation3DAlgorithm() :
...
void LongitudinalAssociation3DAlgorithm::GetListOfCleanClusters(const ClusterList *const pClusterList, ClusterVector &clusterVector) const
{
...
void LongitudinalAssociation3DAlgorithm::PopulateClusterAssociationMap(const ClusterVector &clusterVector, ClusterAssociationMap &clusterAssociationMap) const
{
...
bool LongitudinalAssociation3DAlgorithm::IsExtremalCluster(const bool isForward, const Cluster *const pCurrentCluster, const Cluster *const pTestCluster) const
{
...
bool LongitudinalAssociation3DAlgorithm::AreClustersAssociated(const Cluster *const pInnerCluster, const Cluster *const pOuterCluster) const
{
...
bool LongitudinalAssociation3DAlgorithm::AreClustersAssociated(const CartesianVector &innerClusterEnd,
...
StatusCode LongitudinalAssociation3DAlgorithm::ReadSettings(const TiXmlHandle xmlHandle)
{
