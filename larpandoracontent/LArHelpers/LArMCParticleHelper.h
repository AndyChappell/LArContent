...
public:
    ...
    /**
     *  @brief  Check whether or not an MC particle comes from a primary process
     *
     *  @param  pMCParticle The MC particle to consider
     *
     *  @return  Whether or not the MC particle came from a primary process
     */
    static bool IsPrimaryProcess(const pandora::MCParticle *const pMCParticle);
