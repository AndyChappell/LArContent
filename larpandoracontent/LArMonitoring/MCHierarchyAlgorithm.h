...
private:
    ...
    void Explore(const pandora::MCParticle *const pMCi, std::string indent="") const;

    float GetInvisibleContribution(const pandora::MCParticle *const pMC, const bool priorVisible) const;
